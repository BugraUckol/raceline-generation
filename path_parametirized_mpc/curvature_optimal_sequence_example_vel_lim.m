...
opti.minimize(1.0 * U(2,:) * U(2,:)' + 0.0 * t(end)); % minimize steering
...
plot(x_y_yaw_curv_s_lx_ly_rx_ry_dl_dr(1:lim+1,1), ...
    x_y_yaw_curv_s_lx_ly_rx_ry_dl_dr(1:lim+1,2), 'LineWidth', 2);
